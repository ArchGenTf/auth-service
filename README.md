...
This repository houses the Auth Service microservice. CI/CD builds, quality gates, and automated GitOps deployments are handled via a centralized reusable pipeline.
...
- **Helm Directory**: `auth-service`
- **Dev Registry Repository**: `acrarchgendev.azurecr.io/auth-service`
- **Prod Registry Repository**: `acrarchgenprod.azurecr.io/auth-service`
- **Local Smoke Test Port**: `8001`
...
5. **Local Smoke Test**: Spins up the container on port `8001`, curls `/healthz` to verify startup success, and tears it down.
